...
function Dog(dogeThings){
  this.color = 'black';
  this.hungry = true; //set the default
  if(dogeThings && dogeThings.hungry !== undefined) {
    this.hungry = dogeThings.hungry; //then bring in a question. does dogeThings have .hungry?
  }; //If not, set this.hungry to give it the .hungry.
  this.status = 'normal';
};
